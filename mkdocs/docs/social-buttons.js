...
(function () {
    ...
    var buttonClass = 'social-button';

    var iframeURL = 'https://buttons.github.io/buttons.html';
    ...
    var ds = ".btn:focus-visible,.social-count:focus-visible{outline:2px solid #2f81f7;outline-offset:-2px}.btn{color:#f0f3f6;background-color:#5769e9;border-color:#2f3439;background-image:none;filter:none}.btn:hover,.btn:focus{background-color:#5769e9;background-position:0 -0.5em;border-color:#bdc4cc;background-image:none;filter:none}.btn:active{background-color:#2f81f7;border-color:#bdc4cc}";

    var yt = ".btn:focus-visible,.social-count:focus-visible{outline:2px solid #2f81f7;outline-offset:-2px}.btn{color:#f0f3f6;background-color:#ff0000;border-color:#2f3439;background-image:none;filter:none}.btn:hover,.btn:focus{background-color:#ff0000;background-position:0 -0.5em;border-color:#bdc4cc;background-image:none;filter:none}.btn:active{background-color:#1d1d1f;border-color:#bdc4cc}.social-count{color:#f0f3f6;background-color:#0a0c10;border-color:#7a828e}.social-count:hover,.social-count:focus{color:#71b7ff}.octicon-heart{color:#ef6eb1}";
